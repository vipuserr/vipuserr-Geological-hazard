...
class QgsDistWidget : public QWidget
{
	Q_OBJECT
...
public:
	...
	//! Constrructor
	explicit QgsDistWidget(const QString &label = QString(), QWidget *parent = nullptr);
 ...
 * \since QGIS 3.2
 */
class QgsMapToolSelectHandlerExt : public QObject
{
    Q_OBJECT
...
public:
	...
	//! constructor
	QgsMapToolSelectHandlerExt(QgsMapCanvas *canvas,
	QgsMapToolSelectHandlerExt::SelectionMode selectionMode = QgsMapToolSelectHandlerExt::SelectionMode::SelectSimple);

	//! destructor
	~QgsMapToolSelectHandlerExt() override;
	...
	void canvasDoubleClickEvent(QgsMapMouseEvent* e);
...
private:
	...
	QgsDistWidget *mDistanceWidget = nullptr;
