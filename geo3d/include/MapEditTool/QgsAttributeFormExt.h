...
#include "QgsAttributeFormEditorWidgetExt.h"
...
class QgsAttributeFormEditorWidgetExt;
class QgsMessageBar;
 ...
 */
class QgsAttributeFormExt : public QWidget
{
    Q_OBJECT
  ...
  public:
    ...
    explicit QgsAttributeFormExt( QgsVectorLayer *vl,
                               const QgsFeature &feature = QgsFeature(),
                               const QgsAttributeEditorContext &context = QgsAttributeEditorContext(),
                               QWidget *parent SIP_TRANSFERTHIS = nullptr );
    ~QgsAttributeFormExt() override;
     ...
     * \param iface
     */
    void addInterface( QgsAttributeFormInterfaceExt *iface SIP_TRANSFER );
  ...
  signals:
     ...
     * \since QGIS 2.16
     */
    void filterExpressionSet( const QString &expression, QgsAttributeFormExt::FilterType type );
  ...
  private:
    ...
    QList<QgsAttributeFormInterfaceExt *> mInterfaces;
    QMap< int, QgsAttributeFormEditorWidgetExt * > mFormEditorWidgets;
    QList< QgsAttributeFormWidgetExt *> mFormWidgets;
