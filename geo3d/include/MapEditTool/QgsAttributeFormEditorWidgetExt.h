/***************************************************************************
    QgsAttributeFormEditorWidgetExt.h
     -----------------------------
    Date                 : March 2016
...
#include "QgsAttributeFormWidgetExt.h"
 ...
 * \since QGIS 2.16
 */
class QgsAttributeFormEditorWidgetExt : public QgsAttributeFormWidgetExt
{
    Q_OBJECT
  ...
  public:
    ...
    /**
     * Constructor for QgsAttributeFormEditorWidgetExt.
     ...
     */
    explicit QgsAttributeFormEditorWidgetExt( QgsEditorWidgetWrapper *editorWidget, const QString &widgetType,
                                           QgsAttributeFormExt *form  SIP_TRANSFERTHIS );

    ~QgsAttributeFormEditorWidgetExt() override;
