/***************************************************************************
    QgsAttributeFormRelationEditorWidgetExt.h
     --------------------------------------
    Date                 : Nov 2017
 ...
 * \since QGIS 3.0
 */
class QgsAttributeFormRelationEditorWidgetExt : public QgsAttributeFormWidgetExt
{
    Q_OBJECT
  ...
  public:
     ...
     * Constructor
     */
    explicit QgsAttributeFormRelationEditorWidgetExt( QgsRelationWidgetWrapper *wrapper, QgsAttributeFormExt *form );
