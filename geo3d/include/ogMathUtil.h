...
namespace OC
{
   ...
   public:
    ...
    protected:
        ...
        /// Radian -> index factor value ( mTrigTableSize / 2 * _PI )
    ...
    public:
        ...
        */
        static inline Real Cos (const CRadian& fValue, bool useTables = false) {
			return (!useTables) ? Real(cos(fValue.valueRadians())) : SinTable(fValue.valueRadians() + _HALF_PI);
		}
        /** Cosine function.
            @param
                fValue Angle in radians
        ...
        */
        static inline Real Cos (Real fValue, bool useTables = false) {
			return (!useTables) ? Real(cos(fValue)) : SinTable(fValue + _HALF_PI);
		}
       ...
       */
		...
		*/
        ...
        static const Real _TWO_PI;
        static const Real _HALF_PI;
