...
namespace Smart3dMap {
    ...
    */
	class _ThreadExport Resource : public StringInterface, public ResourceAlloc
    {
	public:
    ...
    public:
		...
		*/
		Resource(ResourceManager* creator, const OC::String& name, ResourceHandle handle,
        ...
        */
        ...
        /** Prepares the resource for load, if it is not already.  One can call prepare()
            ...
            itself, if needed.  When CORE_THREAD_SUPPORT==1 both load() and prepare() 
            are thread-safe.  When CORE_THREAD_SUPPORT==2 however, only prepare() 
     ...
     /** Loads the resource, if it is not already.
        ...
        */
        ...
        /** Gets resource name.
        */
        virtual const OC::String& getName(void) const 
        { 
            return mName; 
        }
		...
		*/
		...
		@remarks
			...
			thread support (CORE_THREAD_SUPPORT). If a resource has been marked
		...
		*/
		...
		virtual const OC::String& getGroup(void) const { return mGroup; }
		...
		*/
		virtual void changeGroupOwnership(const OC::String& newGroup);
		...
		@remarks
			...
			to populate it.
		*/
		virtual const OC::String& getOrigin(void) const { return mOrigin; }
		/// Notify this resource of it's origin
		virtual void _notifyOrigin(const OC::String& origin) { mOrigin = origin; }
	...
	*/
	...
	@note
		...
		at any time.
	*/
	class _ThreadExport ManualResourceLoader
	{
	public:
         ...
         * (CORE_THREAD_SUPPORT==2).  Thus, you must not access the rendersystem from
