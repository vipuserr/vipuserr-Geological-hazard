...
namespace Smart3dMap
{
	...
	typedef std::OC::String _StringBase;
	typedef _StringBase OC::String;
	typedef _StringStreamBase OC::StringStream;
	typedef OC::StringStream StrStreamType;
	*/
	...
	*/
    ...
    public: // constructors
        ...
        explicit Any(const ValueType & value)
          : mContent(CORE_NEW_T(holder<ValueType>, MEMCATEGORY_GENERAL)(value))
        {
        }
    ...
    public: // queries
		...
		void destroy()
		{
			CORE_DELETE_T(mContent, placeholder, MEMCATEGORY_GENERAL);
			mContent = NULL;
		}
    ...
    protected: // types
        ...
        public: // queries
            ...
            {
                return CORE_NEW_T(holder, MEMCATEGORY_GENERAL)(held);
            }
	...
	*/
	...
	public:
		...
		{
			mContent = CORE_NEW_T(numholder<ValueType>, MEMCATEGORY_GENERAL)(value);
		}
	...
	protected:
		...
		public: // queries
			...
			virtual placeholder * clone() const
			{
				return CORE_NEW_T(numholder, MEMCATEGORY_GENERAL)(held);
			}

			virtual placeholder* add(placeholder* rhs)
			{
				return CORE_NEW_T(numholder, MEMCATEGORY_GENERAL)(held + static_cast<numholder*>(rhs)->held);
			}
			...
			{
				return CORE_NEW_T(numholder, MEMCATEGORY_GENERAL)(held * factor);
			}
