...
class S3D_GEOMMAPLIB_EXPORT GenRgnMapProto {
public:
	std::string					m_GenRgnName;//图名称
	PointColor					m_ValidColor;   //有效点颜色样式
	PointColor					m_InValidColor;	//无效点颜色样式
	PointColor					m_UnKnowColor;	//未知点颜色样式
	bool						m_CreatePointIcon;//是否生成点位图
	bool						m_MergeLayer;//是否合并成图
