...
namespace Smart3dMap {
 /** \addtogroup Core
    ...
    */
    ...
    {
        /// Use OG_DELETE to free the memory
        SPFM_DELETE,
    ...
    public:
        ...
        {
            CORE_DELETE_T(mObject, T, MEMCATEGORY_GENERAL);
        }
    };
    ...
    public:
        ...
        {
            CORE_FREE(mObject, MEMCATEGORY_GENERAL);
        }
    };
    ...
    */
    ...
    private:
        ...
        {
            switch(method) {
                case SPFM_DELETE:   return CORE_NEW_T(SharedPtrInfoDelete<T>,  MEMCATEGORY_GENERAL) (rep);
                case SPFM_DELETE_T: return CORE_NEW_T(SharedPtrInfoDeleteT<T>, MEMCATEGORY_GENERAL) (rep);
                case SPFM_FREE:     return CORE_NEW_T(SharedPtrInfoFree<T>,    MEMCATEGORY_GENERAL) (rep);
                case SPFM_NONE:     return CORE_NEW_T(SharedPtrInfoNone,       MEMCATEGORY_GENERAL) ();
            }
            assert(!"Bad method");
            return 0;
        }
    ...
    protected:
        ...
        {
            assert(pRep && pInfo);
            CORE_DELETE_T(pInfo, SharedPtrInfo, MEMCATEGORY_GENERAL);
        }
