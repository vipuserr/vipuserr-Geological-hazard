...
namespace Smart3dMap {
	...
	*/
    ...
    class _ThreadExport ParameterDef
    {
    public:
        OC::String name;
        OC::String description;
        ParameterType paramType;
        ParameterDef(const OC::String& newName, const OC::String& newDescription, ParameterType newType)
            : name(newName), description(newDescription), paramType(newType) {}
    };
    typedef std::vector<ParameterDef> ParameterList;

    /** Abstract class which is command object which gets/sets parameters.*/
    class _ThreadExport ParamCommand
    {
    public:
        virtual OC::String doGet(const void* target) const = 0;
        virtual void doSet(void* target, const OC::String& val) = 0;

        virtual ~ParamCommand() { }
    };
    typedef std::map<OC::String, ParamCommand* > ParamCommandMap;

    /** Class to hold a dictionary of parameters for a single class. */
    class _ThreadExport ParamDictionary
    {
    ...
    protected:
        ...
        ParamCommand* getParamCommand(const OC::String& name)
        {
		...
		const ParamCommand* getParamCommand(const OC::String& name) const
        {
    ...
    typedef std::map<OC::String, ParamDictionary> ParamDictionaryMap;
    ...
    */
    class _ThreadExport StringInterface 
    {
    private:
		CORE_STATIC_MUTEX( msDictionaryMutex )

        /// Dictionary of parameters
        static ParamDictionaryMap msDictionary;

        /// Class name for this instance to be used as a lookup (must be initialised by subclasses)
        OC::String mParamDictName;
	...
	protected:
        ...
        */
        bool createParamDictionary(const OC::String& className)
        {
			CORE_LOCK_MUTEX( msDictionaryMutex )
    ...
    public:
        ...
        */
        ...
        @remarks
            Call this method with the name of a parameter and a OC::String version of the value
            to set. The implementor will convert the OC::String to a native type internally.
            If in doubt, check the parameter definition in the list returned from 
            StringInterface::getParameters.
        @param
            name The name of the parameter to set
        @param
            value OC::String value. Must be in the right format for the type specified in the parameter definition.
            See the OC::StringConverter class for more information.
        @return
            true if set was successful, false otherwise (NB no exceptions thrown - tolerant method)
        */
        virtual bool setParameter(const OC::String& name, const OC::String& value);
        ...
        */
        ...
        @remarks
            Call this method with the name of a parameter to retrieve a OC::String-format value of
            ...
            like you can use OC::StringConverter to convert this OC::String back into a native type.
        @param
            name The name of the parameter to get
        @return
            OC::String value of parameter, blank if not found
        */
        virtual OC::String getParameter(const OC::String& name) const
        {
            // Get dictionary
        ...
        @remarks
            ...
            way to copy parameters to other objects. Note that because of the OC::String manipulation 
