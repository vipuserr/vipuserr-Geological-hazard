...
#else
	#pragma comment(lib, "S3dDBEngine.lib")
...
public:
	...
	void Connect(
		...
		StrEnc clientEnc = StrEnc::GBK, StrEnc serverEnc = StrEnc::SYSTEM_DEFAUTL) SQLAPI_THROW(SAException);
	...
	void GetStringEncoding(StrEnc& clientEnc, StrEnc& serverEnc) const;
};
...
private:
	...
	SAString ClientToServer(const SAString& str) const;
	SAString ServerToClient(const SAString& str) const;
...
protected:
	...
	virtual SAString ServerToClient(const SAString& str) const;
...
protected:
	...
	virtual SAString ServerToClient(const SAString& str) const override;
